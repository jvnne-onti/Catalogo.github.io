...
const productos = [
    {
      ...
      descripción: 'Breach" es el octavo álbum de estudio del dúo estadounidense Twenty One Pilots. Fue lanzado el 12 de septiembre de 2025.',
      precio: 299.00,
      imagen: 'img1.png'
    },
    {
      nombre: 'Album Wiped Out! - The Neighbourhood',
      descripción: 'Wiped Out es el segundo álbum de estudio de la banda alternativa estadounidense The Neighbourhood. Fue lanzado el 30 de octubre de 2015 por Columbia Records.',
      precio: 278.00,
      imagen: 'img2.jpeg'
    },
    {
      nombre: 'Album Unforgiven - Le Sserafim',
      descripción: 'Unforgiven es el primer álbum de estudio de larga duración del grupo femenino surcoreano Le Sserafim. Fue lanzado por Source Music el 1 de mayo de 2023 ',
      precio: 669.00,
      imagen: 'img3.jpg'
    },
    {
      nombre: 'Love Yourself:結 Answer - BTS',
      descripción: 'Love Yourself 結 Answer es el tercer álbum recopilatorio del grupo surcoreano BTS. El álbum fue lanzado el 24 de agosto de 2018 por Big Hit Entertainment ',
      precio: 699.00,
      imagen: 'img4.png'
    }
  ];
